...
*** TODO Chapter 9 and Again and Again and Again
...
** TODO Mathmatical similarity: measurements of distance in machine learning :@MATH:statistics: 
 ...
 position of each point, but in more case, we deliberately use alternative ways
 to discreminate them. There are different type of way to mathmatically define
...
** DONE Building personal website with Hugo
...
website name like /awesome.ai/ or rent some cloud based services to boost up
your website.  
...
*** 3. Download a Hugo theme.
You could take your time browse the Hugo theme shop and choose a theme according
to your need. There are demos, which are real websites people build with the
